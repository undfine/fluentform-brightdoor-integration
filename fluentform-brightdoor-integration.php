...
add_action('init', function (){
    ...
    if (!defined('FLUENTFORM') ) {
        add_action( 'admin_notices', function(){
            ...
            $message = esc_html__( 'FluentForm Brightdoor Integration Add-On Requires FluentForm', 'ff_brightdoor' );
    ...
    if( !class_exists('FF_BrightDoor')){
        ...
        add_action( 'admin_notices', function(){
            ...
            $message = esc_html__( 'The FF Brightdoor Class is already in use, please deactivate or uninstall the conflicting plugin', 'ff_brightdoor' );
            echo '<div class="notice notice-success is-dismissible"><p>'.$message.'</p></div>';
